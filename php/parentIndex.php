...
<body class="container">
    ...
    <h1 class="login-title">Parent Login</h1>
        <form name="form" method="POST" action="parentLogin.php" onsubmit="return isvalid()">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="submit" id="btn" value="Login" name="parent_login_submit" class="btn btn-primary"/>
            </div>
        </form>
    </div>
