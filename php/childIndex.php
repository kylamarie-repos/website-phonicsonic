...
<head>
  ...
  <form name="form" method="POST" action="childLogin.php" onsubmit="return isvalid()">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="submit" id="btn" value="Login" name="child_login_submit" class="btn btn-primary"/>
            </div>
        </form>
  </div>
