<?php
    ...
    if (isset($_POST['edu_login_submit'])) 
    {
        $email = $_POST['email'];
        $pass = $_POST['pass'];

        $sql = "select id from educators where email = '$email' and pass = '$pass'";  
        ...
        if($result->num_rows==1)
        {
            ...
            header("Location: educatorProfile.php");
            exit();
        } else
        {
        ...
        if (isset($_SESSION["login_error"])) {
            ...
            <a href='educatorIndex.php'<button class='btn btn-primary'>Educator Login</button></a>
            </div>
            ";
